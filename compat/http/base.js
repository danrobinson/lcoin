...
HTTPBase.prototype._initRouter = function _initRouter() {
  var self = this;
  this.server.on('request', co( /*#__PURE__*/_regenerator2.default.mark(function _callee(hreq, hres) {
    var req, res;
...
HTTPBase.prototype.handleRequest = co( /*#__PURE__*/_regenerator2.default.mark(function handleRequest(req, res) {
  var i, routes, route, params;
  return _regenerator2.default.wrap(function handleRequest$(_context2) {
    while (1) {
...
HTTPBase.prototype.cors = function cors() {
  return co( /*#__PURE__*/_regenerator2.default.mark(function _callee2(req, res) {
...
HTTPBase.prototype.basicAuth = function basicAuth(options) {
  ...
  if (user) {
    if (typeof user === 'string') user = Buffer.from(user, 'utf8');
  ...
  return co( /*#__PURE__*/_regenerator2.default.mark(function _callee3(req, res) {
    var auth, parts, username, password, digest;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            return _context4.abrupt('return', fail(res));
...
HTTPBase.prototype.bodyParser = function bodyParser(options) {
  ...
  return co( /*#__PURE__*/_regenerator2.default.mark(function _callee4(req, res) {
...
HTTPBase.prototype.parseBody = co( /*#__PURE__*/_regenerator2.default.mark(function parseBody(req, opt) {
  var body, type, data;
  return _regenerator2.default.wrap(function parseBody$(_context6) {
    while (1) {
      switch (_context6.prev = _context6.next) {
        ...
        case 4:
          _context6.next = 6;
          return this.readBody(req, 'utf8', opt);
        ...
        case 9:
          ...
          if (opt.contentType) type = opt.contentType;

          _context6.t0 = type;
          _context6.next = _context6.t0 === 'json' ? 13 : _context6.t0 === 'form' ? 15 : 17;
          break;
...
HTTPBase.prototype.jsonRPC = function jsonRPC(rpc) {
  return co( /*#__PURE__*/_regenerator2.default.mark(function _callee5(req, res) {
    var json;
...
HTTPBase.prototype.handleMounts = co( /*#__PURE__*/_regenerator2.default.mark(function handleMounts(req, res) {
  var url, i, route, server;
  return _regenerator2.default.wrap(function handleMounts$(_context8) {
    while (1) {
...
HTTPBase.prototype.handleStack = co( /*#__PURE__*/_regenerator2.default.mark(function handleStack(req, res) {
  var i, route;
  return _regenerator2.default.wrap(function handleStack$(_context9) {
    while (1) {
...
HTTPBase.prototype.handleHooks = co( /*#__PURE__*/_regenerator2.default.mark(function handleHooks(req, res) {
  var i, route;
  return _regenerator2.default.wrap(function handleHooks$(_context10) {
    while (1) {
      switch (_context10.prev = _context10.next) {
        ...
        case 1:
          ...
          return _context10.abrupt('continue', 9);
...
HTTPBase.prototype.removeSocket = function removeSocket(socket) {
  var keys = (0, _keys2.default)(socket.channels);
  var i, key;
...
HTTPBase.prototype.leaveChannel = function leaveChannel(socket, name) {
  ...
  if (list.size === 0) delete this.channels[name];
...
Route.prototype.match = function match(pathname) {
  ...
  params = (0, _create2.default)(null);
...
Route.prototype.call = co( /*#__PURE__*/_regenerator2.default.mark(function call(req, res) {
  return _regenerator2.default.wrap(function call$(_context11) {
    while (1) {
...
WebSocket.prototype.onevent = co( /*#__PURE__*/_regenerator2.default.mark(function onevent(packet) {
  var args, type, ack, result;
  return _regenerator2.default.wrap(function onevent$(_context12) {
    while (1) {
...
WebSocket.prototype.fire = co( /*#__PURE__*/_regenerator2.default.mark(function fire(type, args) {
  var handler;
  return _regenerator2.default.wrap(function fire$(_context13) {
    while (1) {
