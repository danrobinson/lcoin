...
HTTPClient.prototype._open = co( /*#__PURE__*/_regenerator2.default.mark(function _open() {
  var self, IOClient;
      ...
      switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          this.socket.on('version', function (info) {
            if (info.network !== self.network.type) self.emit('error', new Error('Wrong network.'));
          });
...
HTTPClient.prototype._request = co( /*#__PURE__*/_regenerator2.default.mark(function _request(method, endpoint, json) {
  var query, network, res;
  return _regenerator2.default.wrap(function _request$(_context2) {
    while (1) {
...
HTTPClient.prototype.send = function send(id, options) {
  ...
  if (options.rate) options.rate = Amount.btc(options.rate);
...
HTTPClient.prototype.retoken = co( /*#__PURE__*/_regenerator2.default.mark(function retoken(id, passphrase) {
  var options, body;
    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.next = 3;
          return this._post('/wallet/' + id + '/retoken', options);
