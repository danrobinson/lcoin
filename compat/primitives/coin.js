...
Coin.prototype.fromJSON = function fromJSON(json) {
  ...
  assert(json.height === -1 || util.isUInt32(json.height), 'Height must be a uint32.');
...
Coin.isCoin = function isCoin(obj) {
  return obj && typeof obj.version === 'number' && (0, _typeof3.default)(obj.script) === 'object' && typeof obj.getDepth === 'function';
};
