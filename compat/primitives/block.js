...
Block.prototype.createMerkleRoot = function createMerkleRoot(enc) {
  ...
  if (root.malleated) return null;

  return enc === 'hex' ? root.hash.toString('hex') : root.hash;
};
...
Block.isBlock = function isBlock(obj) {
  return obj && typeof obj.merkleRoot === 'string' && typeof obj.getClaimed === 'function';
};
