...
function Output(options) {
  if (!(this instanceof Output)) return new Output(options);
...
Output.isOutput = function isOutput(obj) {
  return obj && typeof obj.value === 'number' && (0, _typeof3.default)(obj.script) === 'object' && typeof obj.getAddress === 'function';
};
