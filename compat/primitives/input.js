...
function Input(options) {
  if (!(this instanceof Input)) return new Input(options);
...
Input.prototype.getJSON = function getJSON(network, coin) {
  ...
  if (!coin) {
    ...
    if (address) address = address.toString(network);
  }
...
Input.isInput = function isInput(obj) {
  return obj && (0, _typeof3.default)(obj.prevout) === 'object' && (0, _typeof3.default)(obj.script) === 'object' && (0, _typeof3.default)(obj.witness) === 'object' && typeof obj.getAddress === 'function';
};
