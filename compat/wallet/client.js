...
WalletClient.prototype._open = co( /*#__PURE__*/_regenerator2.default.mark(function _open() {
  var self;
...
WalletClient.prototype.estimateFee = function estimateFee(blocks) {
  var self = this;
  return new _promise2.default(function (resolve, reject) {
    self.socket.emit('estimate fee', blocks, wrap(resolve, reject, Amount.value));
  });
};
