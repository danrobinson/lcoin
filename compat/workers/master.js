...
var HAS_WORKERS = typeof global.postMessage === 'function';
var HAS_CP = !!(process.stdin && process.stdout && process.stderr);
var server;
...
Master.prototype.destroy = function destroy() {
  if (HAS_WORKERS) return global.close();
...
if (HAS_WORKERS) global.master = server;
